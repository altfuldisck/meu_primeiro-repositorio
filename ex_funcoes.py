...
def lucro(receita, custo):  #aqui vc fala qual é a função
    lucro = receita - custo
    return lucro
...
def juros_compostos(capital, taxa, tempo):
    ...
    M = round(M, 2) #round arredonda p duas casas decimais
    return M
